                        ...
                        <div ref={createRef()} className="flex min-w-[60vw] items-center justify-between md:min-w-[90vw]">
                            ...
                            <div className="hidden md:block">
                                <div ref={createRef()} className="ml-10 flex items-baseline space-x-4">
                                    ...
                                    <Link to="/team" className={currentPath === '/team' ? style_link_active : style_link}>
                                        Team
                                    </Link>
                    ...
                    {() => (
                        <div className="md:hidden" id="mobile-menu">
                            <div ref={createRef()} className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                                ...
                                <Link to="/team" className={currentPath === '/team' ? style_dd_link_active : style_dd_link}>
                                    Team
                                </Link>
                                ...
                                <Link to="https://wiki.kuchengames.de" className={style_dd_link}>
                                    Wiki
                                </Link>
                            </div>
                        </div>
